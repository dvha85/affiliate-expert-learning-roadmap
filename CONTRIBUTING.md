...
Xem [`docs/SOURCE-MAPPING.md`](docs/SOURCE-MAPPING.md).

Không tự ý đổi Part/Chapter/Lesson ID, main Project, LAB hoặc PASS Gate nếu chưa thay đổi canonical syllabus.
...
Mọi lesson phải có canonical `S:` ref.

`T:` và `R:` chỉ thêm khi nguồn thực sự hỗ trợ nội dung.

Với claim hiện hành về platform policy, attribution window, commission, API, legal, tax, privacy, pricing hoặc software behavior có thể thay đổi, author phải external-verify tại thời điểm viết và cập nhật `last_verified`.
