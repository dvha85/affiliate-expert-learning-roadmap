...
- [ ] **28.9** — Urgency
- [ ] **28.10** — Trust
- [ ] **28.11** — Cognitive Bias

### Chương 29 — Hook Engineering

- [ ] **29.1** — Problem Hook
- [ ] **29.2** — Curiosity Hook
- [ ] **29.3** — Comparison Hook
- [ ] **29.4** — Contrarian Hook
- [ ] **29.5** — Price Hook
- [ ] **29.6** — Result Hook
- [ ] **29.7** — Shock Hook
- [ ] **29.8** — Story Hook
- [ ] **29.9** — Question Hook
- [ ] **29.10** — Hook Measurement

### Chương 30 — Affiliate Content Formats
...
- [ ] **30.5** — Tutorial
- [ ] **30.6** — Unboxing
- [ ] **30.7** — Problem/Solution
- [ ] **30.8** — Deal
- [ ] **30.9** — FAQ
- [ ] **30.10** — Long-term Review

### Chương 31 — Content Architecture
...
### Chương 32 — Content System

- [ ] **32.1** — Content Pillar
- [ ] **32.2** — Content Matrix
- [ ] **32.3** — Content Calendar
- [ ] **32.4** — Repurposing
- [ ] **32.5** — Versioning
...
- [ ] **PROJECT 5 — Real Content Portfolio**
