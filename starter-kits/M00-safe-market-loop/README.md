...
1. Ghi một public observation E1.
2. Viết human hypothesis/claim và weakest assumption.
3. Kiểm disclosure + tracking + policy context.
4. Human review exact artifact.
5. **Human manual publish** hoặc ghi `BLOCKED_EXTERNAL`.
6. Lưu action record/outcome window/next measurement.

Bot/AI không có publish permission trong M00.
