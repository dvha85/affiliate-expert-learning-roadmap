...
- Fixed core timeline: **Phần 0 → 19 → 21**.
- Phần 20 bắt đầu khi có tín hiệu doanh thu; Phần 22 là vòng Continuous Mastery sau core.

Bảng dưới giữ vai trò **curriculum index**, không còn là cam kết “mỗi Part phải xong trong đúng tháng cũ”. Phân bổ tháng cụ thể nằm trong hai timeline docs ở trên.
...
Knowledge roadmap đi theo **Phần 0 → 19 → 21**. Phần 20 (Business & Scale) bắt đầu khi đã có tín hiệu doanh thu; Phần 22 là vòng học liên tục sau khóa chính.

> Cách thực hiện tuần tự/song song sẽ được chuẩn hóa ở Issue #3. Thứ tự knowledge không có nghĩa mọi execution activity phải dừng khi chuyển Part.