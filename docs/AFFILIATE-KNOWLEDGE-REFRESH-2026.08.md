...
- **Source:** TikTok Shop Academy — Promotion Performance Score (PPS)
...
- PPS combines **Product Selection Score** and **Content Score**, weighted 50/50 in the published formula.
...
- AIGC is allowed if it complies with TikTok Shop content policy and community guidelines.
- AI output must not invent product features, fabricate before/after outcomes, or create fake crisis/sympathy stories to pressure sales.
- AIGC disclosure/labeling is part of the platform guidance.

**Curriculum implication:** AI content quality must be evaluated on **truthfulness + product fidelity + disclosure + policy safety**, not only generation quality.
...
- **Source:** TikTok Shop Academy — Latest Policy Updates
...
Browser/vendor decisions remain a watch item.

## 5. Search/discovery is now generative and multimodal
...
## 6. YouTube Shopping Affiliate in Vietnam
...
```text
Old mental model:
content → affiliate link → product page → checkout
...
Affiliate systems should therefore optimize not only links, but also **machine-readable product truth, recommendation quality, source authority, inventory/price freshness and attribution continuity**.

This is an emerging layer, not evidence that traditional affiliate links are obsolete.

## 8. Global disclosure and review integrity
...
- hard-coding current platform thresholds as permanent truths.
